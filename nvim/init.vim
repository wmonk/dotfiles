...
" syntax
  ...
  call dein#add('valloric/MatchTagAlways', {'on_ft': ['html','javascript']})
...
" Theme
  ...
  let g:mocha_js_command = "!mocha --compilers js:babel-register -r jsdom-global/register -r babel-polyfill --no-colors {spec}"
"}}}
